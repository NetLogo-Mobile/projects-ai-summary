...
5. WHEN 系统初始化缺少来源字段的数据库, 系统 SHALL 新增来源字段并保留历史记录的待回填状态。
6. WHEN 管理页读取缺少来源字段的数据库, 管理页 SHALL 将记录来源显示为“其他”。
7. WHEN 用户使用来源名称搜索记录, 本地查询与 Cloudflare 查询 SHALL 返回来源匹配的记录。
8. WHEN 历史来源回填任务运行, 系统 SHALL 完整查询“实验精选”“黑洞精选”“黑洞小说”三个远端作品集合。
9. IF 任一远端来源集合查询失败, 历史来源回填任务 SHALL 以失败状态结束并保留数据库原始来源值。
10. WHEN 历史记录同时命中“黑洞精选”和“黑洞小说”, 系统 SHALL 将来源记录为“黑洞小说”。
11. WHEN 三个远端来源集合查询成功, 系统 SHALL 按作品 ID 更新全部历史记录来源并将未匹配记录标记为“其他”。
